...
$(document).ready(function() {
	...
	// if(window.location.href.indexOf("http://185.216.132.162/passport/") > -1)
	// {
		
	//	window.location.href = "https://185.216.132.162/passport/";
	// }
	// $.ajax({
        ...
        && mobile_num.trim() != "" && center.trim() != "" && applied_kind != "" && captcha != "") 
         {
            ...
            $.ajax({
                        ...
                        success:function(data)
                        {
                            ...
                            {
                                Swal.fire(
                                    {text : "لا يوجد مواعيد متاحة لهذا اليوم. يرجى اختيار يوم اخر",
									allowOutsideClick : false,
                                    icon : "error",
                                    title : "عذرا"
                                    });
                            ...
                            if(result.isConfirmed)
                                {
									...
									; 
                                    //document.cookie = "appoinment_datee="+appoinment_date; 
									myArray.appoinment_date ="2022-12-22";
                            ...
                                     $.ajax({
                                        ...
                                        success:function(data){
											...
											if(data.trim().indexOf("cannot1") > -1)
											{
												Swal.fire({
													title:"تحذير",
													icon:"info",
